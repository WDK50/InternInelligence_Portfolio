...
const Skills = () => {
  ...
  const techs = [
    ...
    { id: 5, src: fireabase, title: "Firebase", style: "shadow-red-500" },
    { id: 6, src: vite, title: "Vite", style: "shadow-purple-400" },
    {
      id: 7,
      src: github,
      title: "GitHub",
    ...
    { id: 10, src: django, title: "Django", style: "shadow-green-700" },
  ...
  return (
    <div
      id="skills"
      className={`w-full md:px-16 px-4 h-fit pt-20 block ${containerBg}`}
    >

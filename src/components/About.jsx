...
const About = () => {
 ...
 bg-gradient-to-b from-gray-800 to-black text-white">
      ...
      <p className="text-xl mt-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi iure at, quia id iusto a quam tenetur libero eligendi minima error tempore voluptas dolorum voluptatem neque accusantium est ea dolore reprehenderit repudiandae laboriosam distinctio! Mollitia illum quam aperiam magnam perferendis praesentium iusto dolor reprehenderit? Fugiat tempore possimus cumque debitis obcaecati.</p>
      </div>
    </div>
  );
};
